...
description: "Submit your first raw.ffmpeg job, poll to completion, and download the result. Under 5 minutes from API key to finished MP4."
icon: "rocket"
keywords: ["rendobar quickstart", "ffmpeg api tutorial", "first api call", "video processing quickstart", "raw ffmpeg job"]
---
...
Get an API key, submit a [`raw.ffmpeg`](/job-types/raw-ffmpeg) job, poll until complete, download the output.
...
- [Raw FFmpeg guide](/guides/raw-ffmpeg): security model, allowed flags, worked examples
