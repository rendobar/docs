---
title: "Install Rendobar MCP"
description: "Configure the local stdio Rendobar MCP server for Claude Desktop, Cursor, Cline, Windsurf, Zed, VS Code, Claude Code, or Continue."
