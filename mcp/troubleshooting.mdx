...
description: "Fix common MCP server failures: missing API key, Cursor PATH on macOS, Windows npx.cmd quirks, minimum Node version, and stdout pollution."
...
The handshake succeeded but `tools/list` returned empty. This is rare — usually means the package version is corrupt.
