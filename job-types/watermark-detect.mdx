...
```bash cURL
curl -X POST https://api.rendobar.com/watermark/detect \
...
const response = await fetch("https://api.rendobar.com/watermark/detect", {
  method: "POST",
  headers: {
...
response = requests.post(
    "https://api.rendobar.com/watermark/detect",
