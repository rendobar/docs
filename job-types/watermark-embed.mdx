...
```bash cURL
curl -X POST https://api.rendobar.com/watermark/embed \
...
const response = await fetch("https://api.rendobar.com/watermark/embed", {
  method: "POST",
  headers: {
...
response = requests.post(
    "https://api.rendobar.com/watermark/embed",
