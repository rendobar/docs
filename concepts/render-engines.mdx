...
**FFmpeg-based job types:** watermark.apply, watermark.remove, transcode, thumbnail, caption.burn, compliance.gdpr.redact, raw.ffmpeg
...
|----------|--------|----------|
| Add a logo to a video | FFmpeg | `watermark.apply` |
