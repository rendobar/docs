...
tag: "Live"
canonical: "https://rendobar.com/docs/jobs/caption-burn"
---
...
Burn subtitles permanently into a video. Provide an SRT, VTT, or ASS file as the `subtitles` input, or omit it to auto-transcribe the audio. Style the text with web-hex colors, an outline, a background box, and a position. This is the static counterpart to [`captions.animate`](/jobs/captions-animate), which renders per-word animated captions.
...
- [captions.animate](/jobs/captions-animate) — per-word animated captions
