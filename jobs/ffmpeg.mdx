...
sidebarTitle: "FFmpeg"
description: "Run any FFmpeg command in the cloud with ~120 whitelisted flags, sandboxed execution, and a signed output URL. Live on all plans, ~$0.05/min."
icon: "terminal"
tag: "Live"
...
- [CLI](/cli/overview): run the same job from your terminal with `rb ffmpeg`
