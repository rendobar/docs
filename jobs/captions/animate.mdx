...
<ParamField body="font" type="string">
  URL of a TTF or OTF font file. Set `style.font` to the family name **embedded in that file** to render captions in it. See [Fonts](#fonts).
</ParamField>
...
<Note>
  Unlike [compose](/jobs/compose#fonts) and [caption.burn](/jobs/captions/burn), this job does not fetch Google Fonts by name. Use a bundled family, or supply your own file.
</Note>
