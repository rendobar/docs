...
keywords: ["caption.burn", "burn subtitles", "SRT", "VTT", "ASS", "hardcoded subtitles", "subtitle styling"]
canonical: "https://rendobar.com/docs/jobs/captions/burn"
---
...
<ParamField body="fontFamily" type="string" default="Inter">
  Font family. Any [Google Fonts](https://fonts.google.com) family works by name and is fetched at render time. Seven are bundled and resolve instantly: `Inter`, `Roboto`, `Montserrat`, `Poppins`, `Oswald`, `Anton`, `Bebas Neue`. To use your own file, pass its URL in the `font` input instead, and it wins over this field.
</ParamField>
