...
"clips": [
  ...
  { "asset": { "type": "video", "src": "https://cdn.rendobar.com/assets/examples/mountain.mp4" }, "start": 2, "length": 3 }
]
```
...
```json
{
  "scenes": [
    { "duration": 4, "transition": { "transition": "crossfade", "duration": 0.6 },
      "clips": [{ "asset": { "type": "video", "src": "https://cdn.rendobar.com/assets/examples/sea.mp4" } }] },
    { "duration": 4, "clips": [{ "asset": { "type": "video", "src": "https://cdn.rendobar.com/assets/examples/mountain.mp4" } }] }
  ],
  "overlays": [
