...
An animated `rotate` has to stay within -180 and 180 degrees at both ends,
because the engine turns a shape over exactly one revolution.
...
| an animated `rotate` beyond -180 to 180 | the engine turns a shape over exactly one revolution | animate in two clips |
