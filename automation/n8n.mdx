...
<Frame caption="The Rendobar node submits a job from a workflow, and the job's callback resumes the workflow when it ends.">
  <img src="/images/automation/hero-n8n.png" alt="The Rendobar mark joined by a connector line to the n8n logo. The caption reads: A verified node for n8n Cloud and self-hosted n8n." />
</Frame>
