...
description: "Troubleshoot common rb CLI errors: install failures, PATH issues, port conflicts, macOS Gatekeeper, expired tokens, rate limits, update rollback."
...
<script
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "@type": "TechArticle",
      "@id": "https://rendobar.com/docs/cli/troubleshooting/#article",
      "headline": "CLI troubleshooting",
      "description": "Fix common rb CLI errors: install failures, PATH issues, port conflicts, macOS Gatekeeper, expired tokens, rate limits.",
