...
<script
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "mainEntityOfPage": { "@id": "https://rendobar.com/docs/support/faq#webpage" },
      "mainEntity": [
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Seconds to minutes, depending on input size and command. Hard caps on processing time: 1 hour (Free), 9 hours (Pro)."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. 120 req/min (Free), 600 req/min (Pro). Applies to REST and MCP. Limit hit returns 429 RATE_LIMITED with a Retry-After header."
          }
        },
        {
          "@type": "Question",
...
<Accordion title="How long do jobs take?">
  Seconds to minutes, depending on input size and command. Hard caps on processing time: 1 hour (Free), 9 hours (Pro). [Limits](/support/limits).
</Accordion>

<Accordion title="Is there a rate limit?">
  Yes. 120 req/min (Free), 600 req/min (Pro). Applies to REST and MCP. Limit hit returns `429 RATE_LIMITED` with a `Retry-After` header.
</Accordion>
