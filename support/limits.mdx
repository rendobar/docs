...
sidebarTitle: "Limits"
description: "Compare Free and Pro plan limits across rate limits (120 vs 600/min), file size caps (500 MB vs 10 GB), retention, concurrency, storage."
icon: "gauge"
...
| Max job timeout | 1 hour | 9 hours |
