...
1. Open [**Webhooks**](https://app.rendobar.com/webhooks) and click **Create Your First Endpoint**.

<Frame caption="The Webhooks page before any endpoints exist.">
  <img src="https://cdn.rendobar.com/assets/docs/webhooks/empty-state.png" alt="Rendobar dashboard Webhooks page empty state with a Create Your First Endpoint button" />
</Frame>
...
<Frame caption="Name, URL, and event selection in the New Endpoint panel.">
  <img src="https://cdn.rendobar.com/assets/docs/webhooks/new-endpoint.png" alt="New Webhook Endpoint panel with a name field, HTTPS URL field, and grouped job and balance event checkboxes" />
</Frame>
