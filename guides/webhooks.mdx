...
Create and manage endpoints in the dashboard.

1. Open [**Webhooks**](https://app.rendobar.com/webhooks).
2. Click **New Endpoint**, name it, paste your **HTTPS** URL, and check the events you want. New endpoints start with `job.completed`, `job.failed`, and `job.cancelled` selected.
